...
?>
                <h2 align="center">非本院个人信息登记</h2>
                <span id="beizu">感谢您加入玉环县第一人民医院团委微信公众平台。</span>
            ...
            <div class="personal_cen">
                ...
                <form action="insert.php" method="post" onsubmit="return save()">
                    ...
                    <p>单位：<input name="contact_keshi" type="text" value="<? echo $val["contact_keshi"]; ?>"></p>

                    <input type="text" hidden="true" name="openid" value="<? echo $openid; ?>" />
                    <input type="text" hidden="true" name="does" value="0" />
