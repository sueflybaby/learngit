...
if(count($selected)==3 && !empty($telephone)){
	if(!empty($check_exist)){
		echo("<h1 align='center'>无法重复投票！</h1>");
	}else{
		mysql_query("insert into chunwan_check_name set openid = '$name',telephone = '$telephone'");
		...
		echo("<h1 align='center'>选择节目数量不足 或 手机未填写，无法投票</h1>");
	}
?>
</body>
</html>